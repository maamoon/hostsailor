        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-4xl mx-auto text-center">
            <div className="flex justify-center mb-6">
              <Building className="h-16 w-16 text-orange-200" />
            </div>
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              مركز البيانات - هولندا
            </h1>
            <p className="text-xl text-orange-100 mb-8">
              البوابة الأوروبية للخدمات السحابية والاستضافة المتقدمة
            </p>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <p className="text-gray-700 leading-relaxed">
                يقع مركز البيانات في هولندا في قلب أوروبا، مما يجعله الموقع المثالي للعملاء 
                الذين يبحثون عن أداء عالي وانخفاض في زمن الاستجابة للأسواق الأوروبية.
              </p>
              <p className="text-gray-700 leading-relaxed">
                تم تصميم المركز وفقاً لأعلى معايير الصناعة مع ضمان 99.99% من وقت التشغيل، 
                وتقنيات الأمان المتقدمة، والالتزام الصارم بقوانين حماية البيانات الأوروبية.
              </p>
            </CardContent>
          </Card>
            ...
            <CardContent className="space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-3">
                  <h4 className="font-semibold text-gray-800">الوصول الأوروبي:</h4>
                  <ul className="list-disc list-inside space-y-1 text-gray-700 text-sm">
                    <li>موقع مركزي في أوروبا</li>
                    <li>وصول سريع لجميع الدول الأوروبية</li>
                    <li>اتصال مباشر بأفريقيا والشرق الأوسط</li>
                    <li>شبكة ألياف ضوئية متقدمة</li>
                  </ul>
                </div>
                <div className="space-y-3">
                  <h4 className="font-semibold text-gray-800">الامتثال القانوني:</h4>
                  <ul className="list-disc list-inside space-y-1 text-gray-700 text-sm">
                    <li>متوافق مع GDPR</li>
                    <li>قوانين حماية البيانات الأوروبية</li>
                    <li>معايير الأمان الأوروبية</li>
                    <li>شفافية في معالجة البيانات</li>
                  </ul>
                </div>
              </div>
            </CardContent>
            ...
            <CardContent className="space-y-6">
              <div className="grid md:grid-cols-3 gap-4">
                <div className="text-center p-4 bg-orange-50 rounded-lg">
                  <div className="text-2xl font-bold text-orange-600">75,000</div>
                  <div className="text-sm text-orange-700">متر مربع</div>
                  <div className="text-xs text-orange-600 mt-1">مساحة المركز</div>
                </div>
                <div className="text-center p-4 bg-green-50 rounded-lg">
                  <div className="text-2xl font-bold text-green-600">2N+1</div>
                  <div className="text-sm text-green-700">نظام الطاقة</div>
                  <div className="text-xs text-green-600 mt-1">مزدوج ومتاح</div>
                </div>
                <div className="text-center p-4 bg-purple-50 rounded-lg">
                  <div className="text-2xl font-bold text-purple-600">N+2</div>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm text-gray-700">Tier IV معتمد</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <CheckCircle className="h-4 w-4 text-green-600" />
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              <div className="grid md:grid-cols-3 gap-4">
                ...
                <div className="text-center p-4 bg-green-50 rounded-lg">
                  <div className="text-2xl font-bold text-green-600">200 Gbps</div>
                  <div className="text-sm text-green-700">سعة الشبكة</div>
                  <div className="text-xs text-green-600 mt-1">إجمالي السعة</div>
                </div>
                <div className="text-center p-4 bg-purple-50 rounded-lg">
                  <div className="text-2xl font-bold text-purple-600">&lt; 2ms</div>
                  <div className="text-sm text-purple-700">زمن الاستجابة</div>
                  <div className="text-xs text-purple-600 mt-1">لأوروبا الغربية</div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <div className="flex items-center gap-2">
                      <CheckCircle className="h-4 w-4 text-green-600" />
                      <span className="text-sm text-gray-700">AMS-IX</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <CheckCircle className="h-4 w-4 text-green-600" />
                      <span className="text-sm text-gray-700">DE-CIX</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <CheckCircle className="h-4 w-4 text-green-600" />
                      <span className="text-sm text-gray-700">LINX</span>
                    </div>
                  </div>
                  <div className="space-y-2">
                    <div className="flex items-center gap-2">
              ...
              <div className="bg-blue-50 p-4 rounded-lg">
                ...
                <div className="grid md:grid-cols-3 gap-4">
                  <div className="text-center">
                    <div className="text-lg font-bold text-blue-600">10 دقيقة</div>
                    <div className="text-sm text-blue-700">الطوارئ</div>
                  </div>
                  <div className="text-center">
                    <div className="text-lg font-bold text-blue-600">30 دقيقة</div>
                    <div className="text-sm text-blue-700">مشاكل الخدمة</div>
                  </div>
                  <div className="text-center">
                    <div className="text-lg font-bold text-blue-600">2 ساعة</div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <p className="text-gray-700">
                للاستفسارات حول مركز البيانات في هولندا أو لزيارة المركز:
              </p>
              <div className="grid md:grid-cols-2 gap-6">
                <div>
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                <p className="text-gray-700 text-sm">
                  <strong>العنوان:</strong> [عنوان مركز البيانات]، أمستردام، هولندا
                </p>
                <p className="text-gray-700 text-sm">
...
export default DataCenterNetherlands; 