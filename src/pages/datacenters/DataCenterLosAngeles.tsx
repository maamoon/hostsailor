        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              مركز البيانات - لوس أنجلوس
            </h1>
            <p className="text-xl text-blue-100 mb-8">
              البنية التحتية المتقدمة في قلب الساحل الغربي للولايات المتحدة
            </p>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <p className="text-gray-700 leading-relaxed">
                يقع مركز البيانات في لوس أنجلوس في موقع استراتيجي في قلب الساحل الغربي للولايات المتحدة، 
                مما يوفر وصولاً سريعاً للعملاء في أمريكا الشمالية وآسيا والمحيط الهادئ.
              </p>
              <p className="text-gray-700 leading-relaxed">
            ...
            <CardContent className="space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-3">
                  <h4 className="font-semibold text-gray-800">الوصول العالمي:</h4>
                  <ul className="list-disc list-inside space-y-1 text-gray-700 text-sm">
                    <li>موقع استراتيجي في الساحل الغربي</li>
                    <li>وصول سريع لأمريكا الشمالية</li>
                    <li>اتصال مباشر بآسيا والمحيط الهادئ</li>
            ...
            <CardContent className="space-y-6">
              <div className="grid md:grid-cols-3 gap-4">
                <div className="text-center p-4 bg-blue-50 rounded-lg">
                  ...
                  <div className="text-sm text-blue-700">قدم مربع</div>
                  <div className="text-xs text-blue-600 mt-1">مساحة المركز</div>
                </div>
                <div className="text-center p-4 bg-green-50 rounded-lg">
                  <div className="text-2xl font-bold text-green-600">2N</div>
              ...
              <div>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-2">
                      <CheckCircle className="h-4 w-4 text-green-600" />
                      <span className="text-sm text-gray-700">HIPAA متوافق</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <CheckCircle className="h-4 w-4 text-green-600" />
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="bg-yellow-50 p-4 rounded-lg">
                <h4 className="font-semibold text-yellow-800 mb-2">ضمان الطاقة:</h4>
                <p className="text-yellow-700">
                  نضمن توفر الطاقة 99.99% من الوقت مع أنظمة احتياطية متعددة 
                  لضمان استمرارية الخدمة حتى في حالة انقطاع الطاقة الرئيسية.
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              <div className="grid md:grid-cols-3 gap-4">
                ...
                <div className="text-center p-4 bg-green-50 rounded-lg">
                  <div className="text-2xl font-bold text-green-600">100 Gbps</div>
                ...
                <div className="text-center p-4 bg-purple-50 rounded-lg">
                  ...
                  <div className="text-xs text-purple-600 mt-1">داخل المركز</div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-2">
                      <CheckCircle className="h-4 w-4 text-green-600" />
                      <span className="text-sm text-gray-700">Hurricane Electric</span>
                    </div>
                  </div>
                  <div className="space-y-2">
                    <div className="flex items-center gap-2">
                      <CheckCircle className="h-4 w-4 text-green-600" />
                      <span className="text-sm text-gray-700">NTT Communications</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <CheckCircle className="h-4 w-4 text-green-600" />
                    ...
                    <div className="flex items-center gap-2">
                      <CheckCircle className="h-4 w-4 text-green-600" />
                      <span className="text-sm text-gray-700">Zayo Group</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <p className="text-gray-700">
                للاستفسارات حول مركز البيانات في لوس أنجلوس أو لزيارة المركز:
              </p>
              <div className="grid md:grid-cols-2 gap-6">
                <div>
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                <p className="text-gray-700 text-sm">
                  <strong>العنوان:</strong> [عنوان مركز البيانات]، لوس أنجلوس، كاليفورنيا، الولايات المتحدة
                </p>
                <p className="text-gray-700 text-sm">
...
export default DataCenterLosAngeles; 